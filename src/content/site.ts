export const heroContent = {
  ...
  proofPoints: [
    ...
    "Acompañamiento estratégico, no confrontacional",
  ],
};
...
export const aboutStats = [
  { value: "20+", label: "años interviniendo en conflictos complejos" },
  { value: "300", label: "acuerdos alcanzados sin juicio" },
  { value: "85%", label: "de casos con reducción de escalada" },
];

export const blogTopics = [
  "Por qué los conflictos escalan",
  "Mediación vs estrategia jurídica",
  "Custodia sin confrontación",
  "Negociación laboral sistémica",
  "Impacto sistémico en procesos judiciales",
];
